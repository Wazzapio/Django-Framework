...
class ProfileCreateView(FormView, BaseClassContextMixin):
    model = User
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if self.send_verify_link(user):
                ...
                messages.success(request, 'Вы успешно зарегистрировались!\n Для активации учетной записи пройдите по'
                                          'ссылке, которая отправлена Вам на почту.')
...
class ProfileUpdateView(UpdateView, BaseClassContextMixin, UserDispatchMixin):
    ...
    title = 'Geekshop | Обновить пользователя'
